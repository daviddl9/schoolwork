...
class LabOneA {
  ...
  static class Simulator {
    ...
    private static final int MAX_NUMBER_OF_EVENTS = 100; // Maximum number of events
    private static final double SERVICE_TIME = 1.0; // Time spent serving a customer
